...
const closeBtnProfile = document.querySelector(".popup_close-profile");
const closeBtnCard = document.querySelector(".popup_close-card");
const closeBtnAlbum = document.querySelector(".popup_close-album");
